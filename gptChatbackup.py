...
#     model="gpt-4o-mini",  # 使用 OpenAI 的 gpt-4o-mini 模型
#     # api_key="sk-...", # Optional if you have an OPENAI_API_KEY environment variable set.
# )

# classifier_agent = AssistantAgent(
#     name="Classifier",
#     model_client=openai_model_client,  # 使用 OpenAI 模型客戶端
...
#     # ------ openai>=1.0.0 async API
#     try:
#         print("🚀 發送 prompt 給 OpenAI API 中...")
...
#         return f"⚠️ 呼叫 OpenAI API 時發生錯誤：{str(e)}"
